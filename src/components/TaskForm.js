...
function TaskForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className='bg-zinc-800 max-w-sm p-4 mb-1'>
      ...
      <textarea name="description" placeholder="descriptio n" onChange={handleChange} value={task.description} className='w-full p-2 rounded-md bg-zinc-600 mb-2'></textarea>
